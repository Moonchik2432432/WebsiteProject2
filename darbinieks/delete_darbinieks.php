...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    $check_sql = "SELECT COUNT(*) FROM Piegade WHERE Piegades_darbinieks_ID = ?";
    if ($check_stmt = mysqli_prepare($link, $check_sql)) {
        ...
        if ($count > 0) {
            ...
            $err = "Nevar dzēst: šis darbinieks tiek izmantots tabulā 'Piegade'.";
        } else {
            // Nav atkarību – var dzēst
            $sql = "DELETE FROM Darbinieks WHERE id = ?";
...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="mt-4 mb-3">Dzēst darbinieku</h2>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="alert alert-danger">
                        ...
                        <p>Vai tiešām vēlaties dzēst šo darbinieku ierakstu?</p>
                        <p>
                            <input type="submit" value="Ja" class="btn btn-danger">
                            <a href="darbinieki.php" class="btn btn-secondary">Nē</a>
                        </p>
                    </div>
                </form>
            </div>
